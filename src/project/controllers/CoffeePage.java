...
//		rd1.include(request, response);
		...
		ModelAndView model = new ModelAndView("SelectedChoice");
		model.addObject("coffeeName",coffee.getCoffeeName());
		model.addObject("milkPercent",coffee.getMilkPercent());
		model.addObject("coffeePercent",coffee.getCoffeePercent());
